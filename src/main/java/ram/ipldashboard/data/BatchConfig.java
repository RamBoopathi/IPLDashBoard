...
public class BatchConfig {
    ...
    private final String[] FILED_NAMES = new String[] { "id", "city", "date", "player_of_match", "venue",
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>().name("MatchItemReader")
                .resource(new ClassPathResource("match_data.csv")).delimited().names(FILED_NAMES)
